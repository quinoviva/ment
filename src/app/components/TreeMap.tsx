        ...
        <div style="min-width: 220px; font-family: sans-serif; padding: 5px;">
          ...
          <div style="font-size: 13px; line-height: 1.5; color: #334155;">
            <div style="margin-bottom: 8px; padding-bottom: 8px; border-bottom: 1px solid #f1f5f9;">
              <p style="margin: 0; font-size: 10px; font-bold; text-transform: uppercase; color: #64748b;">📍 Address</p>
              <p style="margin: 2px 0 0 0; font-weight: 600; color: #1e293b;">${tree.address || 'Address not available'}</p>
            </div>

            <p style="margin: 4px 0;"><strong>Participants:</strong> ${tree.name}</p>
            <p style="margin: 4px 0;"><strong>Status:</strong> <span style="background-color: ${getMarkerColor(tree.healthStatus)}; color: white; padding: 2px 8px; border-radius: 4px; font-size: 11px;">${tree.healthStatus}</span></p>
            ...
            <div style="margin-top: 10px; padding-top: 8px; border-top: 1px solid #f1f5f9;">
              <p style="margin: 0; font-size: 9px; color: #94a3b8; font-mono;">
                COORDINATES: ${tree.latitude.toFixed(6)}, ${tree.longitude.toFixed(6)}
              </p>
              <p style="margin: 2px 0 0 0; font-size: 9px; color: #94a3b8;">ID: ${tree.id}</p>
            </div>
          </div>
        </div>
      `, {
